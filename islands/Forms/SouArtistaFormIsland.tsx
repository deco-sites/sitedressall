...
const SouArtistaFormIsland = () => {
  ...
  const handleSubmit = async (e: JSX.TargetedSubmitEvent<HTMLFormElement>) => {
    ...
    const fields = Object.entries(data).map(([key, value]) => {
      ...
      // console.log(value, 'data de nascimento')
      // }
    ...
    const resultEmail = await invoke.site.actions.getArtistaMetaObject({
      handle: "cleyton.mendes@wedigi.com.br",
    });
    ...
    console.log(result, resultEmail, "result");
  };
  return (
    <div>
      {sucess &&
        (
          <div class="bg-[#F1F1F1] w-full py-8 rounded-[30px]">
            <h3 class="text-center text-3xl font-bold mb-4">Obrigado!</h3>
            <p class="text-center text-sm">Cadastro efetuado com sucesso!</p>
          </div>
        )}
      {error &&
        (
          <div class="bg-[#F1F1F1] w-full py-8 rounded-[30px]">
            <h3 class="text-center text-3xl font-bold mb-4">Desculpe!</h3>
          ...
          <>
            ...
            <form onSubmit={handleSubmit} ref={formRef}>
              {!pessoaJuridica &&
                (
                  <div>
                    ...
                    <div class="flex gap-4 mb-4 flex-col lg:flex-row">
                      <div class="flex flex-col flex-1">
                        <label class="text-base block mb-2" htmlFor="cpf">
                          cpf
                        </label>
                        <input
                          class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                    ...
                    <div class="flex gap-4 mb-4 flex-col lg:flex-row">
                      <div class="flex flex-col flex-1">
                        <label class="text-base block mb-2" htmlFor="email">
                          e-mail
                        </label>
                        <input
                          class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                ...
                (
                  <div>
                    <div class="flex flex-col lg:flex-row gap-4 mb-4">
                      ...
                      <div class="flex flex-col flex-1">
                        <label class="text-base block mb-2" htmlFor="cnpj">
                          CNPJ
                        </label>
                        <input
                          class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
              ...
              <div>
                ...
                <div class="flex gap-4 mb-4">
                  <div class="flex flex-col flex-1">
                    <label class="text-base block mb-2" htmlFor="cep">
                      cep
                    </label>
                    <input
                      class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                ...
                <div class="flex gap-4 mb-4 flex-col lg:flex-row">
                  <div class="flex flex-col flex-1">
                    <label class="text-base block mb-2" htmlFor="rua">
                      rua
                    </label>
                    <input
                      class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                  ...
                  <div class="flex flex-col flex-1">
                    <label class="text-base block mb-2" htmlFor="numero">
                      número
                    </label>
                    <input
                      class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                ...
                <div class="flex gap-4 mb-4 flex-col lg:flex-row">
                  <div class="flex flex-col flex-1">
                    <label class="text-base block mb-2" htmlFor="complemento">
                      complemento
                    </label>
                    <input
                      class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                  ...
                  <div class="flex flex-col flex-1">
                    <label class="text-base block mb-2" htmlFor="bairro">
                      bairro
                    </label>
                    <input
                      class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                ...
                <div class="flex gap-4 mb-4 flex-col lg:flex-row">
                  <div class="flex flex-col flex-1">
                    <label class="text-base block mb-2" htmlFor="cidade">
                      cidade
                    </label>
                    <input
                      class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
                  ...
                  <div class="flex flex-col flex-1">
                    <label class="text-base block mb-2" htmlFor="estado">
                      estado
                    </label>
                    <input
                      class="border border-[#4F4F4F] rounded-[5px] py-3 px-4"
